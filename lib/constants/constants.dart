...
const double sixtyPercentOpacity = 0.6;

//sizes
const double appbarProfilePicRadius = 20;
const double drawerProfilePicRadius = 50;

//styling
const TextStyle appBarLabelTextStyle = TextStyle(
  fontFamily: 'WorkSans',
  fontWeight: FontWeight.w700,
  //update opacity 60 default
);
const TextStyle drawerLabelTextStyle = TextStyle(
  fontFamily: 'WorkSans',
  fontWeight: FontWeight.w700,
  fontSize: 24,
  color: Colors.white,
